...
<head>
    ...
    <link rel="stylesheet" href="/baikhanh1/assets/css/plugins.css">
    <link rel="stylesheet" href="/baikhanh1/assets/css/style.css">
    <script src="/baikhanh1/assets/js/plugins.js"></script>
    <script src="/baikhanh1/assets/js/main.js"></script>
    <!-- CSS 
    ========================= -->
                ...
                <div class="middel_inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="logo">
                                <a href="index.php">
                                    <h3>Shop phụ kiện điện thoại</h3>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4">
