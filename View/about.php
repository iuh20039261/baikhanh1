...
<body>
    ...
    <!--banner area end-->
        <!--Intruduce shop-->
        <div class="intruduce_shop">

            <div class="container" style="color: black;">
                <h1 >Về Chúng Tôi</h1>
                <p style="font-size: 20px;">Chào mừng bạn đến với <strong>Shop Phụ Kiện Điện Thoại</strong> – nơi chuyên cung cấp các phụ kiện chất lượng cao dành cho điện thoại di động.</p>
                <p style="font-size: 25px;">Chúng tôi mang đến:</p>
                <ul style="font-size: 20px;">
                    <li>✅ Bao da sang trọng cho Samsung, iPhone, Oppo...</li>
                    <li>✅ Ốp lưng thời trang, bền bỉ</li>
                    <li>✅ Cáp sạc nhanh, ổn định và an toàn</li>
                    <li>✅ Dán cường lực 9H bảo vệ màn hình tối đa</li>
                    <li>✅ Thẻ nhớ tốc độ cao lưu trữ dữ liệu thoải mái</li>
                </ul>
                <p style="font-size: 20px;">Sự hài lòng của khách hàng là mục tiêu hàng đầu của chúng tôi.</p>
            </div>
            <br>
            <br>
        </div>
